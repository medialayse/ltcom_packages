...
//                        ***************   完成したプログラムの配布について    ***************
//
//  DelphiARX2002 が作成するプログラムファイルは、smpentsamp.drx です。
//  あなたが作成したsmpentsamp.drx とランタイムファイルsmpentsamp.arx を一緒に配布してください。
//  AutoCADにロードする時は、smpentsamp.arx ファイルを指定してください。
//
//                        ***************       プロジェクトの構成について      ***************
//
