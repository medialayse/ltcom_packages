...
//                        ***************   完成したプログラムの配布について    ***************
//
//  DelphiARX2002 が作成するプログラムファイルは、smpcomsamp.drx です。
//  あなたが作成したsmpcomsamp.drx とランタイムファイルsmpcomsamp.arx を一緒に配布してください。
//  AutoCADにロードする時は、smpcomsamp.arx ファイルを指定してください。
//
//                        ***************       プロジェクトの構成について      ***************
//
...
uses
  ...
  DArxH,
  DockForm in 'DockForm.pas' {ArxDockForm1};
