...
//[ARX REGISTORY APPNAME]
	DARX_REGAPPNAME: PChar = DARX_RDS + 'dbsamp';
...
begin
	darxDocManager.ArxCommand(ARXCMD_DBSHOW);
end;
...
//}}DARX_ADDREACTOR
//{{DARX_ARXADDCMD
	AddCommand(DARX_RDS + 'SDA', 'DBSHOW', 'DBSHOW', ACRX_CMD_TRANSPARENT or ACRX_CMD_USEPICKSET, @ARXCMDDBSHOW);
//}}DARX_ARXADDCMD
