...
//                        ***************   完成したプログラムの配布について    ***************
//
//  DelphiARX2002 が作成するプログラムファイルは、smpdbsamp.drx です。
//  あなたが作成したsmpdbsamp.drx とランタイムファイルsmpdbsamp.arx を一緒に配布してください。
//  AutoCADにロードする時は、smpdbsamp.arx ファイルを指定してください。
//
//                        ***************       プロジェクトの構成について      ***************
//
...
uses
  ...
  DArxH,
  MlesForm in 'MlesForm.pas' {ArxForm1};
