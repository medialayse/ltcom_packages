...
//                        ***************   完成したプログラムの配布について    ***************
//
//  DelphiARX2002 が作成するプログラムファイルは、smpformsamp.drx です。
//  あなたが作成したsmpformsamp.drx とランタイムファイルsmpformsamp.arx を一緒に配布してください。
//  AutoCADにロードする時は、smpformsamp.arx ファイルを指定してください。
//
//                        ***************       プロジェクトの構成について      ***************
//
...
uses
  ...
  DArxH,
  Unit1 in 'Unit1.pas' {ArxForm1},
  Unit2 in 'Unit2.pas' {ArxForm2};
