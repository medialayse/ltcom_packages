...
//[ARX REGISTORY APPNAME]
	DARX_REGAPPNAME: PChar = DARX_RDS + 'formsamp';
...
begin
	darxDocManager.ArxCommand(ARXCMD_FORM1);
end;

procedure ARXCMDFORM2;
begin
	darxDocManager.ArxCommand(ARXCMD_FORM2);
end;

procedure ARXCMDFORM2CMD;
begin
	darxDocManager.ArxCommand(ARXCMD_FORM2CMD);
end;
...
//}}DARX_ADDREACTOR
//{{DARX_ARXADDCMD
	AddCommand(DARX_RDS + 'SDA', 'FORM1', 'FORM1', ACRX_CMD_TRANSPARENT or ACRX_CMD_USEPICKSET, @ARXCMDFORM1);
	AddCommand(DARX_RDS + 'SDA', 'FORM2', 'FORM2', ACRX_CMD_TRANSPARENT or ACRX_CMD_USEPICKSET, @ARXCMDFORM2);
	AddCommand(DARX_RDS + 'SDA', 'FORM2CMD', 'FORM2CMD', ACRX_CMD_TRANSPARENT or ACRX_CMD_USEPICKSET, @ARXCMDFORM2CMD);
//}}DARX_ARXADDCMD
