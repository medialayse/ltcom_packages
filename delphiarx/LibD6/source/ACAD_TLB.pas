...
// *********************************************************************//
  ...
  AcadPlotConfiguration = IAcadLayout;
  AcadLayout = IAcadPlotConfiguration;
  ...
  AcadDimension = IAcadDimAligned;
  AcadDimAligned = IAcadDimension;
  ...
  AcadBlock = IAcadModelSpace;
  AcadModelSpace = IAcadBlock;
...
// *********************************************************************//
  IAcadDatabase = interface(IDispatch)
    ...
    function Get_ModelSpace: IAcadBlock; safecall;
    ...
    property ModelSpace: IAcadBlock read Get_ModelSpace;
...
// *********************************************************************//
  IAcadDatabaseDisp = dispinterface
    ['{B9A2B985-2805-11D2-B678-0060B087E235}']
    property ModelSpace: IAcadBlock readonly dispid 1;
...
// *********************************************************************//
  IAcadBlock = interface(IAcadObject)
    ...
    function AddDimAligned(ExtLine1Point: OleVariant; ExtLine2Point: OleVariant;
                           TextPosition: OleVariant): IAcadDimension; safecall;
    ...
    function Get_Layout: IAcadPlotConfiguration; safecall;
    ...
    property Layout: IAcadPlotConfiguration read Get_Layout;
...
// *********************************************************************//
  IAcadBlockDisp = dispinterface
    ...
    function AddDimAligned(ExtLine1Point: OleVariant; ExtLine2Point: OleVariant;
                           TextPosition: OleVariant): IAcadDimension; dispid 1549;
    function AddDimAngular(AngleVertex: OleVariant; FirstEndPoint: OleVariant;
    ...
    property Layout: IAcadPlotConfiguration readonly dispid 1583;
...
// *********************************************************************//
  IAcadPlotConfiguration = interface(IAcadObject)
    ...
    procedure CopyFrom(const pPlotConfig: IAcadLayout); safecall;
...
// *********************************************************************//
  IAcadPlotConfigurationDisp = dispinterface
    ...
    procedure CopyFrom(const pPlotConfig: IAcadLayout); dispid 35;
...
// *********************************************************************//
  IAcadLayout = interface(IAcadPlotConfiguration)
    ...
    function Get_Block: IAcadModelSpace; safecall;
    function Get_TabOrder: Integer; safecall;
    procedure Set_TabOrder(pOrder: Integer); safecall;
    property Block: IAcadModelSpace read Get_Block;
...
// *********************************************************************//
  IAcadLayoutDisp = dispinterface
    ['{B2547D8E-056E-11D2-B651-0060B087E235}']
    property Block: IAcadModelSpace readonly dispid 48;
...
// *********************************************************************//
  IAcadBlocks = interface(IAcadObject)
    ...
    function Item(Index: OleVariant): IAcadModelSpace; safecall;
    function Get_Count: Integer; safecall;
    function Get__NewEnum: IUnknown; safecall;
    function Add(InsertionPoint: OleVariant; const Name: WideString): IAcadModelSpace; safecall;
    property Count: Integer read Get_Count;
    property _NewEnum: IUnknown read Get__NewEnum;
  end;
...
// *********************************************************************//
  IAcadBlocksDisp = dispinterface
    ['{A1617E98-FB21-11D1-A2C8-080009DC639A}']
    function Item(Index: OleVariant): IAcadModelSpace; dispid 0;
    property Count: Integer readonly dispid 1;
    property _NewEnum: IUnknown readonly dispid -4;
    function Add(InsertionPoint: OleVariant; const Name: WideString): IAcadModelSpace; dispid 2;
    property Handle: WideString readonly dispid 1024;
    property ObjectName: WideString readonly dispid 1025;
    procedure GetXData(const AppName: WideString; out XDataType: OleVariant;
                       out XDataValue: OleVariant); dispid 1026;
...
// *********************************************************************//
  IAcadLayouts = interface(IAcadObject)
    ...
    function Get_Count: Integer; safecall;
    function Get__NewEnum: IUnknown; safecall;
    function Add(const Name: WideString): IAcadPlotConfiguration; safecall;
    property Count: Integer read Get_Count;
    property _NewEnum: IUnknown read Get__NewEnum;
  end;
...
// *********************************************************************//
  IAcadLayoutsDisp = dispinterface
    ...
    property Count: Integer readonly dispid 1;
    property _NewEnum: IUnknown readonly dispid -4;
    function Add(const Name: WideString): IAcadPlotConfiguration; dispid 2;
    property Handle: WideString readonly dispid 1024;
    property ObjectName: WideString readonly dispid 1025;
    procedure GetXData(const AppName: WideString; out XDataType: OleVariant;
                       out XDataValue: OleVariant); dispid 1026;
...
// *********************************************************************//
  IAcadPlotConfigurations = interface(IAcadObject)
    ...
    function Get_Count: Integer; safecall;
    function Get__NewEnum: IUnknown; safecall;
    function Add(const Name: WideString; ModelType: OleVariant): IAcadLayout; safecall;
    property Count: Integer read Get_Count;
    property _NewEnum: IUnknown read Get__NewEnum;
  end;
...
// *********************************************************************//
  IAcadPlotConfigurationsDisp = dispinterface
    ...
    property Count: Integer readonly dispid 1;
    property _NewEnum: IUnknown readonly dispid -4;
    function Add(const Name: WideString; ModelType: OleVariant): IAcadLayout; dispid 2;
    property Handle: WideString readonly dispid 1024;
    property ObjectName: WideString readonly dispid 1025;
    procedure GetXData(const AppName: WideString; out XDataType: OleVariant;
                       out XDataValue: OleVariant); dispid 1026;
...
// *********************************************************************//
  IAcadDocument = interface(IAcadDatabase)
    ...
    procedure Set_ActiveLayout(const pLayout: IAcadPlotConfiguration); safecall;
    function Get_ActiveLayout: IAcadPlotConfiguration; safecall;
    ...
    property ActiveLayout: IAcadPlotConfiguration read Get_ActiveLayout write Set_ActiveLayout;
...
// *********************************************************************//
  IAcadDocumentDisp = dispinterface
    ...
    property ActiveLayout: IAcadPlotConfiguration dispid 62;
...
class function CoAcadPlotConfiguration.Create: IAcadLayout;
begin
  Result := CreateComObject(CLASS_AcadPlotConfiguration) as IAcadLayout;
end;

class function CoAcadPlotConfiguration.CreateRemote(const MachineName: string): IAcadLayout;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_AcadPlotConfiguration) as IAcadLayout;
end;

class function CoAcadLayout.Create: IAcadPlotConfiguration;
begin
  Result := CreateComObject(CLASS_AcadLayout) as IAcadPlotConfiguration;
end;

class function CoAcadLayout.CreateRemote(const MachineName: string): IAcadPlotConfiguration;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_AcadLayout) as IAcadPlotConfiguration;
end;
...
class function CoAcadDimension.Create: IAcadDimAligned;
begin
  Result := CreateComObject(CLASS_AcadDimension) as IAcadDimAligned;
end;

class function CoAcadDimension.CreateRemote(const MachineName: string): IAcadDimAligned;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_AcadDimension) as IAcadDimAligned;
end;

class function CoAcadDimAligned.Create: IAcadDimension;
begin
  Result := CreateComObject(CLASS_AcadDimAligned) as IAcadDimension;
end;

class function CoAcadDimAligned.CreateRemote(const MachineName: string): IAcadDimension;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_AcadDimAligned) as IAcadDimension;
end;
...
class function CoAcadBlock.Create: IAcadModelSpace;
begin
  Result := CreateComObject(CLASS_AcadBlock) as IAcadModelSpace;
end;

class function CoAcadBlock.CreateRemote(const MachineName: string): IAcadModelSpace;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_AcadBlock) as IAcadModelSpace;
end;

class function CoAcadModelSpace.Create: IAcadBlock;
begin
  Result := CreateComObject(CLASS_AcadModelSpace) as IAcadBlock;
end;

class function CoAcadModelSpace.CreateRemote(const MachineName: string): IAcadBlock;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_AcadModelSpace) as IAcadBlock;
end;
